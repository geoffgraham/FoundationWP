...
function foundationwp_menu_fallback() {
	...
	// Translators 1: Link to Menus, 2: Link to Customize
  	printf( __( 'Please assign a menu to the primary menu location under %1$s or %2$s the design.', 'foundationwp' ),
  		sprintf(  __( '<a href="%s">Menus</a>', 'foundationwp' ),
  			get_admin_url( get_current_blog_id(), 'nav-menus.php' )
  		),
  		sprintf(  __( '<a href="%s">Customize</a>', 'foundationwp' ),
...
function foundationwp_active_nav_class( $classes, $item ) {
...
add_filter( 'wp_list_pages', 'foundationwp_active_list_pages_class', 10, 2 );
